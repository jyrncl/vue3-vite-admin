...
const mdContent = ref(`Hello，同学们，欢迎来到 Webpack 的世界。
...
![image.png](http://jyrncl-image.oss-cn-beijing.aliyuncs.com/a620f1c107ee4e5b869aca1bcc49ac86~tplv-k3u1fbpfcp-watermark.image?OSSAccessKeyId=LTAI5tPsFhCKFFNNBLrna8ZF&Expires=3270634838&Signature=4qdnN6sD0UUcmwNAmz8qxlkVvQU%3D)
...
![image.png](http://jyrncl-image.oss-cn-beijing.aliyuncs.com/49584dd774ed4c8dbed1dfda09ecae53~tplv-k3u1fbpfcp-watermark.image?OSSAccessKeyId=LTAI5tPsFhCKFFNNBLrna8ZF&Expires=3270634838&Signature=ci%2B1kOORWNxfEeSMVJe3faKVazg%3D)
...
![image.png](http://jyrncl-image.oss-cn-beijing.aliyuncs.com/25c05841892d41bfae468d496a968442~tplv-k3u1fbpfcp-watermark.image?OSSAccessKeyId=LTAI5tPsFhCKFFNNBLrna8ZF&Expires=3270634838&Signature=BhcXMjtK40OokXlwRiVvWBZFHhY%3D)
...
<template>
  <div class="file-preview">
    <MdPreview :model-value="mdContent" preview-theme="smart-blue" />
  </div>
</template>
